		...
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
			<head>
				...
				<style type="text/css">
					...
					.folder h3 {
						background-image: url(/opml/images/folder-open-icon.gif);
					}
					...
					.folder[open="false"] > h3 {
						background-image: url(/opml/images/folder-icon.gif);
					}
					...
					.feed {
						background-image: url(/opml/images/feed-icon.gif);
					}
					...
					.link a {
						background-image: url(/opml/images/link-icon.gif);
					}
				</style>
