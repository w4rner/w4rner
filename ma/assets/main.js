	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('#slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-9ad5c71e.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-fa6455cd.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
	...
	// Slideshow: slideshow02.
		(function() {
			...
			new slideshowBackground('#slideshow02', {
				...
				images: [
					{
						src: 'assets/images/slideshow02-6367541b.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow02-09d590ce.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow02-6b34f91f.jpg',
						position: 'center',
						motion: 'none',
						speed: 2,
						caption: 'net:work?',
